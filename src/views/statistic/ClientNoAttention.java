...
public class ClientNoAttention extends JDialog {
    ...
    public ClientNoAttention(ActionListener listener, Window window) {
        setUndecorated(true);
    ...
    private void initComponents(ActionListener listener) {
        ...
        titleAttention = new JModelLabel("Clientes No Atendidos",Constant.FONT_ARIAL_ROUNDER_17,Constant.COLOR_WHITE,Constant.COLOR_BLACK);
        ...
        buttonCancel = new RoundedJButton("Cancelar", Command.CANCEL_DIALOG.toString(), listener, Constant.COLOR_RED_LIGHT_1,Color.WHITE);
